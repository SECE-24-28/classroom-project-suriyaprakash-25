...
import { User, Phone, Mail, Lock, CheckCircle, ArrowRight, Home, Sparkles, LogIn } from 'lucide-react';
        ...
        <div className="text-center mb-6">
          ...
          <div className="mb-2 animate-fade-in" style={{animationDelay: '0.1s'}}>
            <div className="flex items-center justify-center gap-2 mb-1.5">
              <Sparkles className="w-4 h-4 text-airtel-yellow animate-pulse" />
              <h2 className="text-3xl font-black text-white tracking-tight">
                Join Airtel
              </h2>
              <Sparkles className="w-4 h-4 text-airtel-yellow animate-pulse" style={{animationDelay: '0.5s'}} />
            </div>
            ...
            <div className="group">
              ...
              {errors.name && (
                <div className="mt-2 animate-fade-in">
                  <p className="text-xs text-red-200 bg-red-500/20 backdrop-blur-xl px-3 py-2 rounded-lg flex items-center gap-2 border border-red-400/30 shadow-lg">
