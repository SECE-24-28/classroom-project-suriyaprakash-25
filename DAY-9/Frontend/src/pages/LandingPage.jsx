...
import { Zap, Shield, CreditCard, Gift, Phone, Wifi, MessageSquare, Clock, Users, Award, TrendingUp, CheckCircle, Sparkles, Star, Rocket, Heart, Target, ChevronRight, Play, ArrowRight, LogOut } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[500px] overflow-hidden bg-gray-900">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none z-5">
          ...
          {/* Floating Sparkles */}
          <Sparkles className="absolute top-24 right-32 w-8 h-8 text-airtel-yellow/60 animate-bounce" style={{animationDuration: '2s'}} />
          <Star className="absolute bottom-32 left-40 w-6 h-6 text-white/40 animate-pulse" style={{animationDuration: '3s'}} />
          <Sparkles className="absolute top-40 left-1/4 w-6 h-6 text-blue-400/50 animate-bounce" style={{animationDuration: '2.5s', animationDelay: '1s'}} />
        </div>
        ...
        <div className="absolute inset-0 flex items-center justify-center z-10">
          <div className="text-center text-white px-4 max-w-5xl mx-auto">
            {/* Animated Badge */}
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-airtel-yellow/90 to-yellow-400/90 backdrop-blur-md rounded-full px-6 py-2 mb-6 animate-fade-in shadow-2xl shadow-airtel-yellow/50 hover:scale-110 transition-transform duration-300 cursor-pointer">
              <Rocket className="w-4 h-4 text-airtel-red animate-bounce" />
              <span className="text-sm font-bold text-airtel-red">India's #1 Recharge Platform</span>
              <Star className="w-4 h-4 text-airtel-red" />
            </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="text-center mb-16 max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-airtel-red/10 to-purple-500/10 rounded-full px-6 py-2 mb-4">
              <Sparkles className="w-5 h-5 text-airtel-red" />
      ...
      <section className="py-20 bg-gradient-to-br from-airtel-yellow via-yellow-400 to-orange-400 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <Sparkles className="absolute top-20 right-32 w-12 h-12 text-white/30 animate-bounce" style={{animationDuration: '3s'}} />
